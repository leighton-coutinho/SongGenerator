...
myurl = "https://api.musixmatch.com/ws/1.1/matcher.lyrics.get?format=json&callback=callback"
artist_format = "&q_artist="
track_format = "&q_track="
api_key = "&apikey=6d53fb360a8874266833b05d8e406140"
...
def get_lyrics(artist,song_title):
    url = myurl + artist_format + artist + track_format + song_title + api_key
    # fetch lyrics
    request = requests.get(url)
    json_data = request.json()
    json_data = json_data['message']['body']
    return json_data['lyrics']['lyrics_body']
